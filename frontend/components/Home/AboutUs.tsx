...
export default function AboutUs() {
    return (
        <section className="section-panel min-h-lvh section-full-width w-full grid grid-cols-1 md:grid-cols-2 font-serif">
            {/* Left Column - Brand Introduction */}
            <div className="bg-espresso-800 text-light_latte p-10 flex items-center sm:px-28">
                <div>
            ...
            <div className="bg-matcha-latte p-10 sm:px-28">

            </div>

            {/* Right Column - Our Philosophy */}
            <div className="bg-esspresso p-10 sm:px-28">

            </div>
            {/* Left Column - Brand Introduction */}
            <div className="text-espresso-800 bg-light_latte p-10 flex items-center sm:px-28">
                <div>
